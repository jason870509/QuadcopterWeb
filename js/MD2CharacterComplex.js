...
console.log("kkkkkkk")
	...
	this.updateBehaviors = function ( delta ) {
		...
		if ( controls.bumflop ) {  // you can add these if necessary

			moveAnimation = animations[ "bumflop" ];
			idleAnimation = animations[ "bumflop" ];

		}		
		if ( controls.deathc ) {  // you can add these if necessary

			moveAnimation = animations[ "deathc" ];
			idleAnimation = animations[ "deathc" ];
